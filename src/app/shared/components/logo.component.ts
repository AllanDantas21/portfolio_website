...
@Component({
  ...
  template: `
    <a routerLink="/" class="group inline-flex items-center p-2 text-lg font-bold text-gray-800 dark:text-gray-100 hover:text-primary dark:hover:text-primary transition-colors duration-200">
      <svg
        width="20"
        height="20"
        class="w-5 h-5 inline-block text-gray-800 dark:text-gray-100 transition-transform duration-200 group-hover:rotate-[20deg]"
        viewBox="0 0 40 40"
        fill="currentColor"
      >
      ...
      <span class="ml-3 font-semibold tracking-tight">
